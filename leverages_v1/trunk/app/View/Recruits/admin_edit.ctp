					...
					<div class="box-content">
                        ...
                        <form class="form-horizontal" method="post">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="startdate"  value="<?php echo $item['Recruit']['startdate']; ?>" name="data[startdate]">
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="enddate"  value="<?php echo $item['Recruit']['enddate']; ?>" name="data[enddate]">
