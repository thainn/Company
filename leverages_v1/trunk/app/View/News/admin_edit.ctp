					...
					<div class="box-content">
                        ...
                        <form class="form-horizontal" method="post" id='newsform'>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="title" name="data[title]"  value="<?php echo $item['News']['title']; ?>">
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" id='url' name="data[url]"  value="<?php echo $item['News']['url']; ?>">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge timepicker" id="publishdate"  value="<?php echo $item['News']['publishdate']; ?>" name="data[publishdate]" readonly style='cursor: pointer;'>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<textarea class="cleditor" rows="3" name="data[content]"> <?php echo $item['News']['content']; ?></textarea>
							  </div>
							</div>
