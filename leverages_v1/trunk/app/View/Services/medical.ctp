...
$(document).ready(function(){
	...
	$.library.active({id:'service03',type:'text'});
});
</script>
<div id="Content">
...
<p class="fig1" align="center">
<img src="<?php echo Configure::read('baseurl');?>frontend/images/medical/figure01.jpg" width="600" height="205" alt="/" />
<br/>Nguồn : Leverages Japan
</p>
